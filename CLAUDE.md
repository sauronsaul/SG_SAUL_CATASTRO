# CLAUDE.md — Contexto Maestro de SG_SAUL_CATASTRO

> **Archivo crítico**: Claude Code DEBE leer este archivo al inicio de CADA sesión, antes de cualquier otra acción. Este archivo es la fuente de verdad del proyecto.
...
**Implicación**: Claude Code construye UN solo sistema. Las diferencias entre modos son archivos de configuración, no ramas de código distintas.
...
## 11. Reglas operativas para Claude Code
...
1. **Leer este CLAUDE.md al inicio de cada sesión**, sin excepciones.
...
9. **Si encuentra contradicción** entre código existente y este CLAUDE.md, **señalarla antes de proceder**.
...
## 18. Recordatorios finales para Claude Code
...
- **Cuando algo no esté en este CLAUDE.md, pregunta antes de decidir.**
