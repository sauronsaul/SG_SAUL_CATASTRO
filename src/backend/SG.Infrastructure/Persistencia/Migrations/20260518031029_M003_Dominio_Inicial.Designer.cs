...
namespace SG.Infrastructure.Persistencia.Migrations
{
    ...
    [Migration("20260518031029_M003_Dominio_Inicial")]
    partial class M003_Dominio_Inicial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SG.Domain.Catalogos.UsoSuelo", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_usos_suelo");

                    b.HasIndex("Codigo")
                        .IsUnique()
                        .HasDatabaseName("uix_usos_suelo_codigo");

                    b.ToTable("usos_suelo", "dominio");
                });
            ...
            modelBuilder.Entity("SG.Domain.Catastro.Predio", b =>
                {
                    b.HasOne("SG.Domain.Catalogos.UsoSuelo", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_predios_usos_suelo_uso_suelo_id");
